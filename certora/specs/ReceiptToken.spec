...
rule mintRevertConditions() {
    ...
    bool isAccountZero = account == 0;
    bool isOwner = e.msg.sender == owner();
    bool isExpectedToRevert = isPayable || isAccountZero || !isOwner;
...
rule burnRevertConditions() {
    ...
    bool isAccountZero = account == 0;
    bool isOwner = e.msg.sender == owner();
    bool isExpectedToRevert = isPayable || hasNotEnoughBalance || isAccountZero || !isOwner;
...
rule transferRevertConditions() {
    ...
    bool isAccountZero = account == 0;
    bool isSenderZero = e.msg.sender == 0;

    bool isExpectedToRevert = isPayable || hasNotEnoughBalance || isAccountZero || isSenderZero;
...
rule transferFromRevertConditions() {
    ...
    bool isOwnerZero = owner == 0;
    bool isRecipientZero = recepient == 0;

    bool isExpectedToRevert = isPayable  || isAllowanceLow || hasNotEnoughBalance || isOwnerZero || isRecipientZero;
...
rule approveRevertConditions() {
	...
	bool isPayable = e.msg.value != 0;
    bool isSpenderZero = spender == 0;
    bool isOwnerZero = owner == 0;

	bool isExpectedToRevert = isPayable || isSpenderZero || isOwnerZero;
